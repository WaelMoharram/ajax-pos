...
@section('address')الرئيسية@endsection
@section('header')
...
@endsection
@section('content')
    <a href="{{route('order.index')}}" class="col-md-12 hvr-float">
        <div class="mt-widget-3">
            <div class="mt-head bg-blue-hoki">
                <div class="mt-head-icon">
                    <i class="fa fa-opencart"></i>
                </div>
                <div class="mt-head-desc"> <h2>ابدأ البيع</h2> </div>
            </div>
        </div>
    </a>
    <br>
    ...
    <div class="col-xs-12">
        <div>
            <h1 class="text-center" style="background-color: #ececec;padding: 20px;"> مبيعات اليوم</h1>
        </div>
        @php($orders = \App\Order::with('details')->where('status','finished')->where('created_at','>',date('Y-m-d'))->get())
